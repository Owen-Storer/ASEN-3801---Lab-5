function xdot = AircraftEOMDoublet(t, aircraft_state, aircraft_surfaces, doublet_size,doublet_time, wind_inertial, aircraft_parameters)

% Doublet Peacewise
del_e = 1;
if t > 0 && t <= doublet_time
    del_e = aircraft_surfaces(1) + deg2rad(doublet_size);
...
aircraft_surfaces(1) = del_e; % Reading New Doublet Elevator Deflection 

% Reading into regular aircraft EOM with new doublet angles
g = 9.81;
h=1609.34;
